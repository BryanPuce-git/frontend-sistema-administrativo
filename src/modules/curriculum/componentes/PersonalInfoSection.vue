    ...
    <div class="mb-4">
      ...
      <div v-if="personalInfoActive" class="p-4 border border-t-0 rounded-b-lg">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <!-- Género -->
          <div>
            <label for="genero" class="block text-gray-700 text-sm font-bold mb-2">Selecciona el género requerido</label>
          ...
          <!-- Ciudad -->
          <div>
            <label for="ciudad" class="block text-gray-700 text-sm font-bold mb-2">Selecciona la(s) ciudad(es) donde dispones del cargo</label>
          ...
          <!-- Estado civil -->
          <div>
            <label for="estado-civil" class="block text-gray-700 text-sm font-bold mb-2">Selecciona estado civil requerido</label>
          ...
          <div>
            <label for="reubicacion" class="block text-gray-700 text-sm font-bold mb-2">¿Capacidad de reubicación?</label>
          ...
          <div>
            <label for="discapacidad" class="block text-gray-700 text-sm font-bold mb-2">¿Candidatos con discapacidad?</label>
        ...
        <div class="bg-red-100 border border-red-300 p-4 rounded-lg mb-6">
          ...
          <p class="text-sm text-black-500 mb-4"><b>Advertencia: </b>selecciona los campos que son indispensables para el perfil. Ten en cuenta que si un candidato no cumple con un campo excluyente será descartado del proceso.</p>
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <label class="inline-flex items-center">
              <input type="checkbox" v-model="excluyentesEstadoCivil" value="estadoCivil" class="form-checkbox text-red-500">
              <span class="ml-2">Estado civil</span>
            </label>
            <label class="inline-flex items-center">
              <input type="checkbox" v-model="excluyentesReubicacion" value="reubicacion" class="form-checkbox text-red-500">
            ...
            <label class="inline-flex items-center">
              <input type="checkbox" v-model="excluyentesDiscapacidad" value="discapacidad" class="form-checkbox text-red-500">
